# restaurantBookingPlatformSysAdminJhipster
...
To build the final jar and optimize the restaurantBookingPlatformSysAdminJhipster application for production, run:
